...
class StepModel:
    ...
    @property
    def has_before_config(self):
        return self._has_phase(PHASES.BEFORE_CONFIG)
    ...
    async def before_config(self, msg_cb):
        """ before-deploy phase
        """
        return await self.run(PHASES.BEFORE_CONFIG, msg_cb)
